...
function seedDeadlines_(ss) {
  ...
  const rows = [
    [shortId_('D'), 'global', '', 'all', 0, '115-1', 'upload_course_result',
      '課程學習成果上傳＋送出認證截止', '2027-02-02T17:00:00+08:00', '各校自訂（通常學期末）；課程成果須修課當學期上傳＋教師認證，逾期無法補件。請至老師後台改為學校實際公告日', now, now],
    [shortId_('D'), 'global', '', 'all', 0, '115-1', 'check_to_central',
      '勾選課程學習成果／多元表現至中央資料庫', '2027-02-26T17:00:00+08:00', '每學年可勾選課程成果 6 件、多元表現 10 件；個申參採至多 3＋10 件、四技甄選件數各系自訂（B-1 至少 1 件）', now, now],
  ];
